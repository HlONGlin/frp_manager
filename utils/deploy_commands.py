...
def build_frpc_deploy_script(server, port, system='linux', security_profile='balanced'):
    ...
    if system == 'windows':
        ...
        ps_script = (
            ...
            "$outLog='frpc-start.out.log'; $errLog='frpc-start.err.log'; "
            f"$p=Start-Process -WindowStyle Hidden -FilePath '.\\frpc.exe' -ArgumentList '-c {config_name}' -RedirectStandardOutput $outLog -RedirectStandardError $errLog -PassThru; "
